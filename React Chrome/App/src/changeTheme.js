...
const EXPRESS_CSS_URL = chrome.runtime.getURL('49EXPRESS.css');
// eslint-disable-next-line no-undef
const SSB_CSS_URL = chrome.runtime.getURL('SSB.css');
var css = '';
...
if (currentURL.includes('https://my.') && domains.includes(currentURL.split('.')[ 0 ])) {
    css = EXPRESS_CSS_URL;
